...
class App():
    ...
    def start_recording(self):
        ...
        myFont = font.Font(weight="bold")
        self.loaded_data =  'AIzaSyBOti4mM-6x9WDnZIjIeyEU21OpBXqWBgw'
    ...
    def stoprecording(self):
        ...
        self.split_audio(self.filename, segment_duration=10)
    ...
    def open_audio(self):
        ...
        self.split_audio(file_path, segment_duration=10)
    ...
    def split_audio(self, audio_path, segment_duration=10):
        print(audio_path)
        ...
        for i in range(num_segments):
            ...
            try:
                segment_text = recognizer.recognize_google(audio_data, language="he-IL", key=self.loaded_data)
